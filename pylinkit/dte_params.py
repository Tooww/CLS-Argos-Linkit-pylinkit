...
class DTEParamMap():
    ...
    [ "BARO_SENSOR_ENABLE_TX_MAX_SAMPLES", "BAP01", UINT ], #Tom #
    [ "BARO_SENSOR_ENABLE", "BAP02", BOOLEAN ], #Tom #
    [ "BARO_SENSOR_PERIODIC", "BAP03", UINT ], #Tom # 
    [ "BARO_SENSOR_ENABLE_TX_SAMPLE_PERIOD", "BAP04", UINT ], #Tom #
    [ "BARO_SENSOR_ENABLE_TX_MODE", "BAP05", SENSORTXENABLEMODE ], #Tom #
    ]
